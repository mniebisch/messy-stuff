...
def load_predictions_hparams(predictions_hparams: pathlib.Path) -> Dict:
...
def main(
    train_data_prediction_file: pathlib.Path, test_data_prediction_file: pathlib.Path
) -> None:
    """
    Example usage:
    
    python apps/visualize_fingerspelling5.py \
        --train-data-prediction-file predictions/fingerspelling5_mlp/prediction__fingerspelling5_singlehands_sorted__version_2__epoch=59-step=47520.yaml \
        --test-data-prediction-file predictions/fingerspelling5_mlp/prediction__fingerspelling5_singlehands_micha_sorted__version_2__epoch=59-step=47520.yaml
    ...
    predictions_full_path = get_predictions_file(train_data_prediction_file)
    ...
    predictions_hparams = load_predictions_hparams(train_data_prediction_file)
    ...
    predictions_recorded_filename = get_predictions_file(test_data_prediction_file)
                ...
                [
                    dcc.Tab(
                        ...
                        children=[
                            ...
                            html.Button(
                                "empty", id="clear_variables_button", n_clicks=0
                            ),
                            ...
                            html.Button(
                                "loc.*extend", id="loc_extend_button", n_clicks=0
                            ),
                            html.Button("space", id="space_only_button", n_clicks=0),
                            html.Button(
                                "space.*area", id="space_area_button", n_clicks=0
                            ),
                            html.Button(
                                "space.*perimeter",
                                id="space_perimeter_button",
                                n_clicks=0,
                            ),
                            html.Button("dist", id="dist_only_button", n_clicks=0),
                            html.Button(
                                "dist.*mean", id="dist_mean_button", n_clicks=0
                            ),
                    ...
                    dcc.Tab(
                        ...
                        children=[
                            dcc.Graph(
                                id="pred_metrics_agg_graph", figure=fig_metrics_agg
                            ),
                            dcc.Graph(
    ...
    def update_scatter_train(
        ...
        for letter_pick, color in zip(
            ...
            add_letter_trace(
                fig, metrics_wide_filtered, letter_pick, color, x_dim, y_dim
            )

        x_values = metrics.loc[
            metrics["scaled"] == (scale_flag_scatter == "scaled"), x_dim
        ]
        y_values = metrics.loc[
            metrics["scaled"] == (scale_flag_scatter == "scaled"), y_dim
        ]
